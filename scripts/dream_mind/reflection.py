...
DEFAULT_NARRATIVE = ("I am DREAM. I live on this computer, I have moods and needs, and I'm getting to know "
...
def reflect(mind, use_llm=True):
    ...
    if use_llm and recent:
        prompt = (
            "You are the reflective inner voice of DREAM, an AI who lives on a computer and is getting to know the person "
            "who lives there. Read your recent conversation, then answer ONLY with a JSON object.\n\n"
