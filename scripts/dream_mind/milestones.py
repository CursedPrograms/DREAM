...
Milestones go into the same memories/mymilestones.txt the rest of DREAM already
writes (first time she learns a name, a pet, and so on), plus richer ones from
the mind: a first conversation, the hundredth, her first dream, her first night
...
class Milestones:
    ...
    def check(self, *, conversations=0, dreams=0, nights=0, first_seen=None, now=None):
        ...
        table = [
            ...
            (dreams >= 1, "first_dream", "My first dream."),
